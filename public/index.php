    ...
    <div class="container">
        <div class="about__box">
            ...
            <div class="about__info">
                ...
                <a href="#" class="about__info-btn btn-b">Скачать прайс <img src="./img/about/download-icon.svg" width="32px" height="32px" alt=""></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container service__container">
        <div class="service__box">
            ...
            <div class="service__box-buttons">
                <a class="service__box-buttons-btn1 btn-b" href="#">Заказать доставку<img src="./img/form/alt-right.svg" width="32px" height="32px" alt=""></a>
