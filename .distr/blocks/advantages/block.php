<section class="advantages">
    <div class="container">
        <div class="advantages__box">
            <img src="./img/advantages/woman.png" alt="" class="advantages__img">
            <div class="advantages__info">
                <div class="advantages__info-subtitle">Наши преимущества</div>
                <div class="advantages__info-title">Находим <span class="emphasized">решения</span> для любой задачи</div>
                ...
                <div class="advantages__info-text">
                    ...
                    <ul class="advantages__info-text-list">
